...
def carregar_dados_excel(url):
    ...
    try:
        ...
        # Cálculo da capacidade a partir das dimensões
...
def calcular_emissoes_evitadas_reator_detalhado(capacidade_litros, periodo_anos=10):
    ...
    # ---- 1. CH₄ ATERRO COM DISTRIBUIÇÃO TEMPORAL E φ ----
    ...
    # ---- 2. N₂O ATERRO (perfil de 5 dias, sem φ) ----
    ...
    # ---- 3. EMISSÕES DA COMPOSTAGEM (50 dias) ----
...
# =============================================================================
# DETALHAMENTO COMPLETO DOS CÁLCULOS (COM FÓRMULAS CORRIGIDAS)
# =============================================================================
